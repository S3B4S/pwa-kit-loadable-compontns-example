...
const UsesLodash = loadable(() =>
  import(
    /* webpackExclude: true */
    '../../components/UsesLodash'
  )
)
...
const Home = () => {
  ...
  const [loadInDynamicComponent, setLoadInDynamicComponent] = React.useState(false)
  ...
  return (
    <Box data-testid="home-page" layerStyle="page">
      ...
      />
      {/* When this button is clicked, `UsesLodash` is rendered for the first time
          The component uses lodash, and is the only component to do so
          So we'd want the lodash module to be fetched only when UsesLodash is rendered for the first time
        */}
      <Button onClick={() => setLoadInDynamicComponent((prev) => !prev)}>
        Load in the dynamic component!
      </Button>
      {loadInDynamicComponent && <UsesLodash />}
      <Hero
